...
import gust.backend.model.PersonRecord.EnrollEvent;
...
public final class ModelMetadataTest {
  @Test void testResolveQualifiedName() {
    final String expectedQualifiedName = "gust.backend.model.Person";
    final String expectedJavaName = "gust.backend.model.PersonRecord$Person";
