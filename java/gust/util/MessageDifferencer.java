 ...
 *
 * <p>Taken from: com.google.common.truth.extensions.proto.MessageDifferencer
 */
@Immutable
public final class MessageDifferencer {

    /**
     * MapKeyComparator is used to determine if two elements have the same key when comparing elements
     * of a repeated field as a map.
     */
    public interface MapKeyComparator {
        /**
         * Decides whether the given messages match with respect to the keys of the map entries they
         * represent.
         *
         * @param parentFields the stack of SpecificFields corresponding to the proto path to the given
         *     messages.
         */
     ...
     * having the same key iff they have the same value for every specified key field. Note that you
     * can also specify only one field as key.
     */
    ...
    public static final class Builder {
        ...
        /**
         * The elements of the given repeated field will be treated as a set for diffing purposes, so
         * different orderings of the same elements will be considered equal. Elements which are present
         * on both sides of the comparison but which have changed position will be reported with {@link
         * ReportType#MOVED}. Elements which only exist on one side or the other are reported with
         * {@link ReportType#ADDED} and {@link ReportType#DELETED} regardless of their positions. {@link
         * ReportType#MODIFIED} is never used for this repeated field. If the only differences between
         * the compared messages is that some fields have been moved, then {@link #compare} will return
         * true.
         *
         * <p>If the scope of comparison is set to {@link Scope#PARTIAL}, extra values added to repeated
         * fields of the second message will not cause {@link #compare} to return false.
         *
         * @throws IllegalArgumentException if the field is not repeated or is is already being as a map
         *     for comparison
         */
        public Builder treatAsSet(FieldDescriptor field) {
            ...
            Preconditions.checkArgument(
                    !mapKeyComparatorMap.containsKey(field),
        ...
        /**
         * Indicates that any field with the given descriptor should be ignored for the purposes of
         * comparing two messages. This applies to fields nested in the message structure as well as top
         * level ones. When the MessageDifferencer encounters an ignored field, it is reported with
         * {@link ReportType#IGNORED}.
         *
         * <p>The only place where the field's 'ignored' status is not applied is when it is being used
         * as a key in a field passed to TreatAsMap or is one of the fields passed to
         * TreatAsMapWithMultipleFieldsAsKey. In this case it is compared in key matching but after that
         * it's ignored in value comparison.
         */
        ...
        /**
         * Sets the type of comparison that is used by the differencer when determining how to compare
         * fields in messages.
         */
        ...
        /** Tells the differencer whether or not to report matches. Defaults to false. */
        ...
        /**
         * Sets the scope of the comparison that is used by the differencer when determining which
         * fields to compare between the messages. Defaults to {@link Scope#FULL}.
         */
        ...
        /**
         * Sets the type of comparison that is used by the differencer when comparing float (and double)
         * fields in messages. Defaults to {@link FloatComparison#EXACT}.
         *
         * <p>If you use {@link Builder#setFieldComparator(FieldComparator)}, this operation will be
         * ignored
         */
        public Builder setFloatComparison(FloatComparison comparison) {
            floatComparison =
                    Preconditions.checkNotNull(comparison, "FloatComparison should not be null.");
            return this;
        }

        /**
         * Sets the {@link FieldComparator} used to determine differences between protocol buffer
         * fields. By default it's set to a {@link DefaultFieldComparator} instance. Note that this
         * method must be called before Compare for the comparator to be used.
         */
        ...
        /**
         * Sets the type of comparison for repeated field that is used by this differencer when compare
         * repeated fields in messages. Defaults to {@link RepeatedFieldComparison#AS_LIST}.
         */
    ...
    private MessageDifferencer(Builder builder) {
        ...
        fieldComparator =
                builder.fieldComparator == null
                        ? new DefaultFieldComparator(floatComparison)
                        : builder.fieldComparator;
    }

    /**
     * Determines whether the supplied messages are equal. Equality is defined as all fields within
     * the two messages being set to the same value. Primitive fields and strings are compared by
     * value while embedded messages/groups are compared as if via a recursive call.
     *
    ...
    /**
     * Determines whether the supplied messages are equivalent. Equivalency is defined as all fields
     * within the two messages having the same value. This differs from the {@link #equals(Message,
     * Message)} method above in that fields with default values are considered set to said value
    ...
    /**
     * Determines whether the supplied messages are approximately equal. Approximate equality is
     * defined as all fields within the two messages being approximately equal. Primitive (non-float)
     * fields and strings are compared by value, floats are compared using an equivalent of C++ {@code
     * MathUtil::AlmostEquals} and embedded messages/groups are compared as if via a recursive call.
     *
     * @throws IllegalArgumentException if the messages have different descriptors
     */
    ...
    /**
     * Determines whether the supplied messages are approximately equivalent. Approximate equivalency
     * is defined as all fields within the two messages being approximately equivalent. As in {@link
     * #approximatelyEquals}, primitive (non-float) fields and strings are compared by value, floats
     * are compared using an equivalent of C++ {@code MathUtil::AlmostEquals} and embedded
     * messages/groups are compared as if via a recursive call. However, fields with default values
     * are considered set to said value, as per {@link #equivalent}.
     *
     * @throws IllegalArgumentException if the messages have different descriptors
     */
     ...
     * called on each criterion until one returns true or all return false. isIgnored is called for
     * fields where at least one side has a value.
     */
    public interface IgnoreCriteria {
         ...
         * @param fieldDescriptor the field being compared (null for unknown fields). More details about
         *     unknown field is available in the last entry of fieldPath.
    ...
    public abstract static class SpecificField {
        ...
        /**
         * Returns the field index. If this a repeated field, this is the index within it. For unknown
         * fields, this is the index of the field among all unknown fields of the same field number and
         * type. For other fields, returns -1.
         */
        public abstract int getIndex();

        /**
         * Returns the new field index. If this field is a repeated field which is being treated as a
         * map or a set, this indicates the position to which the element has been moved. This only
         * applies to {@link ReportType#MOVED}, and (in the case of {@link Builder#treatAsMap}) {@link
         * ReportType#MODIFIED}.
         */
    ...
    /**
     * Interface for comparing protocol buffer fields. Regular users should consider using {@link
     * DefaultFieldComparator} rather than this interface. Currently, this does not support comparing
     * unknown fields.
     */
    public interface FieldComparator {
        ...
        public enum ComparisonResult {
            ...
            /**
             * Compared fields are different. In case of comparing submessages, user should not
             * recursively compare their contents.
             */
            DIFFERENT,

            /**
             * Compared submessages need to be compared recursively. FieldComparator does not specify the
             * semantics of recursive comparison. This value should not be returned for simple values.
             */
            RECURSE;
             ...
             *
             * @return {@link ComparisonResult#SAME} if result is true, {@link ComparisonResult#DIFFERENT}
             *     if result is false.
             */
         ...
         * @param index1 the index of first message. In case the given FieldDescriptor points to a
         *     repeated field, the indices need to be valid. Otherwise they should be ignored.
         * @param index2 the index of second message. In case the given FieldDescriptor points to a
         *     repeated field, the indices need to be valid. Otherwise they should be ignored.
         * @param parentFields an immutable list of fields that was taken to find the current field (not
         *     include current field).
         * @return Returns SAME or DIFFERENT for simple values, and SAME, DIFFERENT or RECURSE for
         *     submessages. Returning RECURSE for fields not being submessages is illegal.
         */
        ComparisonResult compare(
                ...
                int index1,
                int index2,
                ImmutableList<SpecificField> parentFields);
    }
    ...
    public interface Reporter {
         ...
         * @param message1 the first message
         * @param message2 the second message
         * @param fieldPath an immutable list of fields that was taken to find the current field. For
         *     example, for a field found in an embedded message, the list will contain two field
         *     descriptors. The first will be the field of the embedded message itself and the second
         *     will be the actual field in the embedded message that was added/deleted/modified.
         */
        void report(
                ReportType type,
                Message message1,
    ...
    public enum ReportType {
        ...
        /**
         * A repeated field has been moved to another location. This only applies when using {@link
         * Builder#treatAsSet} or {@link Builder#treatAsMap}. Also note that for any given field, {@link
         * #MODIFIED} and {@link #MOVED} are mutually exclusive. If a field has been both moved and
         * modified, then only {@link #MODIFIED} will be used.
         */
        MOVED,

        /**
         * Reports that two fields match. Useful for doing side-by-side diffs. This is mutually
         * exclusive with {@link #MODIFIED} and {@link #MOVED}. Matches must be enabled using {@link
         * Builder#setReportMatches}.
         */
        MATCHED
    }

    /**
     * The type of comparison that is used by the differencer when determining how to compare fields
     * in messages.
     */
    public enum MessageFieldComparison {
        ...
        /**
         * Fields with default values are considered set for comparison purposes even if not explicitly
         * set in the messages themselves. Unknown fields are ignored.
         */
        EQUIVALENT
    }
    ...
    public enum Scope {
        ...
        /**
         * Only fields present in the first message are considered; fields set only in the second
         * message will be skipped during comparison.
         */
        PARTIAL
    }
    ...
    public enum RepeatedFieldComparison {
        /**
         * Repeated fields are compared in order. Differing values at the same index are reported using
         * ReportModified(). If the repeated fields have different numbers of elements, the unpaired
    ...
    /**
     * Compares the two specified messages, returning true if they are the same. Reports differences
     * to the reporter if it is non-null.
     *
     * @throws IllegalArgumentException if the messages have different descriptors
     */
    ...
    /**
     * Same as above, except comparing only the given sets of field descriptors, using only the given
     * message fields.
     *
     * @throws IllegalArgumentException if the messages have different descriptors
     */
    public boolean compareWithFields(
            Message message1,
            Message message2,
    ...
    /**
     * Compares the two specified messages, returning true if they are the same, using only the given
     * message fields. Reports differences to the reporter if it is non-null.
     *
     * @throws IllegalArgumentException if the messages have different descriptors
     */
    public boolean compareWithFields(
    ...
    private void checkSameDescriptor(Message message1, Message message2) {
        Preconditions.checkArgument(
                message1.getDescriptorForType().equals(message2.getDescriptorForType()),
    ...
    private void report(
        ...
        if (field.isRepeated()) {
            ...
            reporter.report(
                    reportType, message1, message2, immutable(stack, SpecificField.forField(field)));
        }
    }
    ...
    private boolean isMatch(
            FieldDescriptor repeatedField,
            @Nullable MapKeyComparator keyComparator,
            Message message1,
            Message message2,
            int index1,
            int index2,
    ...
    /**
     * A message difference reporter that writes a textual description of the differences to a
     * character stream.
     */
    public static final class StreamReporter implements Reporter {
         ...
         * @param reportModifiedAggregates when set to true, the stream reporter will also output
         *     aggregates nodes (i.e. messages and groups) whose subfields have been modified. When
        ...
        private void appendValue(
                Message message, ImmutableList<SpecificField> fieldPath, boolean leftSide)
                throws IOException {
            SpecificField specificField = Iterables.getLast(fieldPath);
            FieldDescriptor field = specificField.getField();
            if (field != null) {
                ...
                Object value =
                        field.isRepeated() ? message.getRepeatedField(field, index) : message.getField(field);
    ...
    public static final class DefaultFieldComparator implements FieldComparator {
        ...
        public ComparisonResult compare(
                ...
                ImmutableList<SpecificField> parentFields) {
            Object value1 =
                    field.isRepeated() ? message1.getRepeatedField(field, index1) : message1.getField(field);
            Object value2 =
                    field.isRepeated() ? message2.getRepeatedField(field, index2) : message2.getField(field);
            ...
            switch (field.getJavaType()) {
                ...
                case FLOAT:
                    if (floatComparison == FloatComparison.EXACT) {
                        ...
                        return ComparisonResult.of(
                                almostEquals(((Number) value1).floatValue(), ((Number) value2).floatValue()));
                    }
                case DOUBLE:
                    if (floatComparison == FloatComparison.EXACT) {
                        return ComparisonResult.of(value1.equals(value2));
                        ...
                        return ComparisonResult.of(
                                almostEquals(((Number) value1).doubleValue(), ((Number) value2).doubleValue()));
                    }
                default:
