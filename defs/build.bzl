...
DEPS = {
    ...
    "com_google_closure_stylesheets": {
        "type": "java",
        "licenses": ["notice"],
        "targets": ["https://storage.googleapis.com/elide-software/closure-stylesheets-1.6.0-b14.jar"],
        "seal": "2749be4b2046360b0cc6d2698b3304cd260fab08619ec5bfdbcd642b668d8734",
        "deps": [
            "@args4j",
