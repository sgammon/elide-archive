...
def _generate_closure_js_progress_message(name):
    ...
    return "Generating Closure Protocol Buffer %s" % name
...
closure_proto_aspect = aspect(
    ...
    attrs = dict({
        ...
        "_closure_library": attr.label(
            default = Label("@io_bazel_rules_closure//closure/library/array"),
        ),
        "_closure_protobuf_jspb": attr.label(
            default = Label("@io_bazel_rules_closure//closure/protobuf:jspb"),
        ),
