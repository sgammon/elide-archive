...
const TasksClient = goog.require('proto.todolist.TasksClient');
...
class TasksAPI {
   ...
   *
   * @return {!TasksClient} API instance for speaking to the Tasks API.
   */
  static acquire() {
    return new TasksClient('http://localhost:8082', null, {});
  }
}
